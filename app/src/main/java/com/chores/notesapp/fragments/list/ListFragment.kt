package com.chores.notesapp.fragments.list
...
import com.chores.notesapp.databinding.FragmentListBinding
import com.chores.notesapp.fragments.SharedViewModels
import com.chores.notesapp.fragments.adapter.ListAdapter
import com.chores.notesapp.utils.hideKeyboard
...
class ListFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    private fun setUpRecyclerView() {
        ...
        listBinding.rvList.layoutManager = StaggeredGridLayoutManager(2,
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            ...
            R.id.menu_priority_low -> mNotesViewModel.sortedByLowPriority.observe(this, {
                adapter.setData(it)})
        }
